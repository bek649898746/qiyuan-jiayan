// v26 — 复刻 GRUB 的 NVMe 队列配置 + Identify
        ...
        若(vid!=0xFFFFFFFF && vid!=0){
            ...
            若(cls==0x0108){
                ...
                *(整*)(mmio+0x1000)=1;  /* SQTDBL */
                整 *cq=(整*)acq;
                t=0;
                循环(((cq[2]>>16)&1)==0){t=t+1;若(t>2000000){sps(c,"CQTO\n");break;}}
                sps(c,"ID ");
                hex32(c,cq[0]);hex32(c,cq[2]);hex32(c,cq[3]);spc(c,10);
