        ...
        若(vid!=0xFFFFFFFF && vid!=0){
            ...
            若(cls==0x0108){
                ...
                *(整*)(mmio+0x14)=0;
                ...
                sps(c,"R0\n");
                整 acq=0x7F00000; 整 asq=0x7F00040;  /* 靠近 RAM 顶, 避开低地址 */
                整 i=0;
                循环(i<256){*(字节*)(acq+i)=0;*(字节*)(asq+i)=0;i=i+1;}
                *(整*)(mmio+0x24)=0x1F001F;  /* AQA @0x24: 32 entries each (0x1F = 31+1) */
                *(整*)(mmio+0x28)=asq; *(整*)(mmio+0x2C)=0;  /* ASQ @0x28 */
                *(整*)(mmio+0x30)=acq; *(整*)(mmio+0x34)=0;  /* ACQ @0x30 */
                *(整*)(mmio+0x14)=1|(6<<16)|(4<<20);
                ...
                sq[0]=0x0A;
                sps(c,"B\n");
                sq[1]=0;sq[2]=0;sq[3]=0;sq[4]=0;sq[5]=0;sq[6]=0;sq[7]=0;
                sq[8]=0;sq[9]=0;sq[10]=1;sq[11]=0;sq[12]=0;sq[13]=0;sq[14]=0;sq[15]=0;
                sps(c,"C\n");
                *(整*)(mmio+0x1000)=1;
                sps(c,"D\n");
                整 *cq=(整*)acq;
                sps(c,"E\n");
                整 v0=cq[0]; 整 v2=cq[2];
                sps(c,"F ");hex32(c,v0);hex32(c,v2);spc(c,10);
                t=0;
                循环(((cq[2]>>16)&1)==0){
                    t=t+1;
                    若(t==100000){sps(c,"G1 ");hex32(c,cq[2]);spc(c,10);}
                    若(t>2000000){sps(c,"G2\n");break;}
                }
                sps(c,"H ");hex32(c,cq[0]);hex32(c,cq[2]);hex32(c,cq[3]);spc(c,10);
