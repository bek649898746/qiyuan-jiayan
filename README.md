...
甲言是一套完整的**中文编程**工具链：**中文编译器**（自举 C 方言）、**中文汇编器** asm_zh、COFF 链接器 jyld 与编译驱动 jycc——从源码到文档全部以中文书写。它证明**中文编程**不是玩具：编译器用中文写自己，三代 SHA256 逐字节一致，可被任何拿到源码的人一条命令重建。

> 2026-08-05 人民网锐评《用"Token"还是"词元"，事关科技话语权》：
> "术语是科技叙事的基础单元……唯有筑牢母语根基、掌握话语主动权，才能在全球科技竞争中实现技术突破与文化自信的双向赋能。"
> 甲言的开源（2026-08-04）比这篇锐评早一天。我们的回答不是争论译名，而是把整条编译链
> 用母语自举——让"词元"成为一门自己编译自己、三代 SHA256 逐字节一致的语言的起点。
